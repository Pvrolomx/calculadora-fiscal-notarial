...
**Última corrida:** 08-ago-2026 → **7/7 casos coinciden al centavo.** Motor validado; fix de depreciación de mejoras (T1) correcto; INPC actualizado a 145.131 (jun/jul-2026).
...
> **Los `esperado` dependen del INPC de venta vigente.** Si se actualiza la tabla INPC/UDI, recalcular los esperados (el oráculo de referencia está reproducido en el motor validado, ver más abajo). En la corrida del 08-ago se usó INPC venta (jul-2026) = **145.131**, INPC compra (oct-2010) = 73.9689, INPC mejoras (feb-2021) = 110.907, UDI = 8.841.

---

## Los 7 casos (esperados verificados)

| # | Caso | Qué prueba | Esperado (INPC 145.131) | Estado 08-ago |
|---|---|---|---|---|
| 1 | Extranjero sin RFC | Art. 160: elige la MENOR (25% s/bruto) | $12,375,000.00 | ✅ |
| 2 | Residente con RFC | tarifa Art. 152, sin exención | $10,860,829.45 | ✅ |
| 3 | Exentando | prorrateo exención (Art. 93 fr. XIX) | $9,250,244.32 | ✅ |
| 4 | **Exent. + mejoras** | **fix T1: deprecia (Art.124) + prorratea** | $2,554,521.77 | ✅ |
| 5 | Con RFC + mejoras | mejoras sin exención | $3,080,642.13 | ✅ |
| 6 | Exención total (borde) | precio < 700k UDIS → todo exento | $0.00 | ✅ |
| 7 | Mejoras sin fecha (borde) | regresión: no rompe sin fecha (nominal) | $9,160,829.45 | ✅ |
...
- INPC: ya actualizado a 145.131 (jun/jul-2026) — verificar que coincida con INEGI al cierre de cada mes.
