...
| T-30 | Panel comisión% (`#comisionPctPanel`, `toggleComisionPct`) tiene el MISMO problema de UX que el USD: única salida sin monto = flechita. Candidato a aplicar click-outside igual que T-29. **Decisión de diseño pendiente del Arquitecto:** generalizar a un mecanismo único de "paneles dismissibles" (DRY, mejor si crecen los paneles) vs. duplicar el patrón de T-29 (más simple para solo 2). Esperar validación de tacto de T-29 en celular antes de replicar | Candidato — decisión Arquitecto |
